                ...
                <div class="card blue-grey darken-1 hoverable">
                    <form method="post">
                        ...
                        <div class="card-action center-align">
                            <button type="submit" class="waves-effect waves-light waves-blue btn">Login</button>
                            <a href="cadastrar.php" class="waves-effect waves-light waves-blue btn">Cadastrar</a>
                        </div>
                    </form>
                </div>
            </div>
